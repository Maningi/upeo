						...
						<div class="content">
							...
							<table  class="table  table-hover table-responsive" >
                                ...
                                <?php if($loans) : ?>
                                    ...
                                    <td><?= $loan['amount']  ?></td>
                                    <td><?= $loan['interest']  ?></td>
                                    <td><?= $loan['bank_charges']  ?></td>
                                    <td><?= $loan['P_balance']  ?></td>
                                    <td><?= $loan['status']  ?></td>
                                    <td><?= $loan['date']  ?></td>
                                    <td><?= $loan['status']  ?></td>
                                    <td><?= $loan['l_member']  ?></td>
                                ...
                                <tbody bgcolor="" class="">
									<tr class="thead">
										<td width="2%" hidden>row</td>										
										<td>Member</th>
										<td>Amount</th>										
										<td>Interest</th>
										<td>Bank Charges</th>
										<td>Principal Balance</th>
										<td>Status</td>
										<td>Date</>	
										<td scope"col" width="5%"><center>Details</center></td>
										<td scope"col" width="5%"><center>Pay</center></td>
										<td scope"col" width="5%"><center>Delete</center></td>
									</tr>
								</tbody>
							</table>	
							<ul class="pagination">							
